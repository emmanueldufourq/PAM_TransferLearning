...
def train_model(model_type, species_folder, augmentation_amount, seed, call_order, INPUT_SHAPE, 
    ...
    db.set_seed(seed)
    X_train, Y_train, data_distribution, train_distribution, new_seed = db.get_data(sample_size,  'thyolo-alethe', call_order)
    ...
    filepath=save_results_folder+'/'+"{}-{}_FineTuned.hdf5".format(seed, model_type)
